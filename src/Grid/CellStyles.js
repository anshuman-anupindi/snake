...
const checkCellHasSnakeAndFood = (
  snakeCoords,
  cellCoords,
  food,
  hasFood,
...
const cellTypeToStyle = (
  ...
  if (cellType(hasSnake, hasFood) == "food") {
    ...
    // TODO: define colors as constants in some common UI file
    ...
    return (
      <div style={rowStyle}>
        {pixelRow.map((pixel, colNum) => {
          ...
          return <div key={colNum} style={pixelStyle}></div>;
        })}
      </div>
    );
  });
